...
case $1 in
  ...
  "load")
    ...
    iptables  -A INPUT  -i enp1s0  -s 127.0.0.0/8  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -A INPUT  -i enp1s0  -s 127.0.0.0/8  -j DROP
    iptables  -A INPUT  -i enp1s0  -s 192.168.2.0/24  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -A INPUT  -i enp1s0  -s 192.168.2.0/24  -j DROP
    iptables  -A INPUT  -i enp1s0  -s 192.168.3.0/24  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -A INPUT  -i enp1s0  -s 192.168.3.0/24  -j DROP
    ...
    iptables  -A udp_filter_in -p udp  -i enp1s0  -s 0.0.0.0  --sport 67  -m pkttype --pkt-type broadcast  -j DROP
    iptables  -A udp_con_out -p udp  -o enp1s0  --dport 67  -j ACCEPT
    iptables  -A udp_con_in -p udp  -i enp1s0  ! -s 0.0.0.0  --sport 67  -m pkttype --pkt-type broadcast  -j ACCEPT
    ...
    iptables  -A udp_srv_in -p udp  -s 192.168.2.0/24  --dport domain  -j ACCEPT
    iptables  -A udp_srv_out -p udp  -d 192.168.2.0/24  --sport domain  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport domain  -m state --state NEW  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport domain  -m state --state NEW  -j NFLOG  --nflog-group 3
    iptables  -A udp_srv_out -p udp  -d 192.168.2.0/24  --sport 67  -j ACCEPT
    iptables  -A udp_srv_in -p udp  -s 192.168.2.0/24  --sport 68  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport rsync  -m state --state NEW  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport rsync  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: RSYNC dropping unmatched"
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport 8080  -m state --state NEW  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport 8080  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: http-proxy dropping unmatched"
    iptables  -A udp_srv_in -p udp  -s 192.168.3.0/24  --dport domain  -j ACCEPT
    iptables  -A udp_srv_out -p udp  -d 192.168.3.0/24  --sport domain  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport domain  -m state --state NEW  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport domain  -m state --state NEW  -j NFLOG  --nflog-group 3
    iptables  -A udp_srv_out -p udp  -d 192.168.3.0/24  --sport 67  -j ACCEPT
    iptables  -A udp_srv_in -p udp  -s 192.168.3.0/24  --sport 68  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport 8080  -m state --state NEW  -j ACCEPT
    iptables  -A tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport 8080  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: http-proxy dropping unmatched"
    ...
    iptables  -I tcp_filter_in -p tcp  --dport 1433  -j DROP
    iptables  -I udp_filter_in -p udp  -i enp1s0  --dport domain  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport domain  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport http  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport https  -j DROP
    iptables  -I udp_filter_in -p udp  -i enp1s0  --dport sunrpc  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport sunrpc  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport telnet  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport ftp  -j DROP
    iptables  -I tcp_filter_in -p tcp  -i enp1s0  --dport ftp-data  -j DROP
    sysctl net.ipv4.ip_forward="1"
    iptables  -t nat  -A POSTROUTING  -o enp1s0  -j MASQUERADE
    iptables  -A FORWARD  -i enp1s0  -m state --state RELATED,ESTABLISHED  -j ACCEPT
  ...
  "unload")
    ...
    iptables  -D INPUT  -i enp1s0  -s 127.0.0.0/8  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -D INPUT  -i enp1s0  -s 127.0.0.0/8  -j DROP
    iptables  -D INPUT  -i enp1s0  -s 192.168.2.0/24  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -D INPUT  -i enp1s0  -s 192.168.2.0/24  -j DROP
    iptables  -D INPUT  -i enp1s0  -s 192.168.3.0/24  -j NFLOG --nflog-group 2  --nflog-prefix "firewall: spoof attempt"
    iptables  -D INPUT  -i enp1s0  -s 192.168.3.0/24  -j DROP
    iptables  -F icmp_filter_in
    iptables  -Z icmp_filter_in
    iptables  -F icmp_filter_out
    iptables  -Z icmp_filter_out
    ...
    iptables  -D udp_filter_in -p udp  -i enp1s0  -s 0.0.0.0  --sport 67  -m pkttype --pkt-type broadcast  -j DROP
    iptables  -D udp_con_out -p udp  -o enp1s0  --dport 67  -j ACCEPT
    iptables  -D udp_con_in -p udp  -i enp1s0  ! -s 0.0.0.0  --sport 67  -m pkttype --pkt-type broadcast  -j ACCEPT
    ...
    iptables  -D udp_srv_in -p udp  -s 192.168.2.0/24  --dport domain  -j ACCEPT
    iptables  -D udp_srv_out -p udp  -d 192.168.2.0/24  --sport domain  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport domain  -m state --state NEW  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport domain  -m state --state NEW  -j NFLOG  --nflog-group 3
    iptables  -D udp_srv_out -p udp  -d 192.168.2.0/24  --sport 67  -j ACCEPT
    iptables  -D udp_srv_in -p udp  -s 192.168.2.0/24  --sport 68  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport rsync  -m state --state NEW  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport rsync  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: RSYNC dropping unmatched"
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport 8080  -m state --state NEW  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.2.0/24  --dport 8080  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: http-proxy dropping unmatched"
    iptables  -D udp_srv_in -p udp  -s 192.168.3.0/24  --dport domain  -j ACCEPT
    iptables  -D udp_srv_out -p udp  -d 192.168.3.0/24  --sport domain  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport domain  -m state --state NEW  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport domain  -m state --state NEW  -j NFLOG  --nflog-group 3
    iptables  -D udp_srv_out -p udp  -d 192.168.3.0/24  --sport 67  -j ACCEPT
    iptables  -D udp_srv_in -p udp  -s 192.168.3.0/24  --sport 68  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport 8080  -m state --state NEW  -j ACCEPT
    iptables  -D tcp_srv_in -p tcp  -s 192.168.3.0/24  --dport 8080  -m state --state NEW  -j NFLOG  --nflog-group 3  --nflog-prefix "firewall: http-proxy dropping unmatched"
    ...
    iptables  -D udp_filter_in -p udp  -i enp1s0  --dport domain  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport domain  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport http  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport https  -j DROP
    iptables  -D udp_filter_in -p udp  -i enp1s0  --dport sunrpc  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport sunrpc  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport telnet  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport ftp  -j DROP
    iptables  -D tcp_filter_in -p tcp  -i enp1s0  --dport ftp-data  -j DROP
    iptables  -t nat  -D POSTROUTING  -o enp1s0  -j MASQUERADE
    iptables  -D FORWARD  -i enp1s0  -m state --state RELATED,ESTABLISHED  -j ACCEPT
    ...
    iptables  -D FORWARD  -s 192.168.2.0/24  -j ACCEPT
    sysctl net.ipv4.ip_forward="0"
